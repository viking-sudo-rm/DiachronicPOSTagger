...
class TemporalLanguageModel:
    ...
    def train(self, session, train_data, dev_data, test_data, embed_data):
        ...
        data_file = "/home/accts/gfs22/LING_380/Data/Output/may_2_run_LR_001_BIG_B.txt"
...
#            if no_improve>3:
 #               break
        ...
        del train_data
        del dev_data
        saver.save(session, "/home/accts/gfs22/LING_380/Data/Output/model_5_2_LR_001_BIG_B")
