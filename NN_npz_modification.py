...
if __name__ == "__main__":
    ...
    #  TODO #
    filename_word = "X_word_array_1880s.npz"
    filename_year = "X_year_array_1880s.npz"
    filename_Y = "Y_array_1880s.npz"
    sample_size = 10000
    ...
    with open(os.path.join(MOD_WORD_PATH, "X_word_array_1880s_MOD.npz"), "wb") as fh:
        np.save(fh, X_word_array_mod)

    with open(os.path.join(MOD_YEAR_PATH, "X_year_array_1880s_MOD.npz"), "wb") as fh:
        np.save(fh, X_year_array_mod)

    with open(os.path.join(MOD_Y_PATH, "Y_array_1880s_MOD.npz"), "wb") as fh:
